...
import spark.agent.ModuleFactory;
import spark.agent.SparkServerModule;
...
class JettyHandler extends SessionHandler {
    ...
    private SparkServerModule module;

    public JettyHandler(Filter filter) {
        this.filter = filter;
        this.module = ModuleFactory.getBean(SparkServerModule.class);
    }
    ...
    public void doHandle(
        ...
        try {
        	...
        	if(baseRequest.isHandled()) {
                ...
                module.requestCompleted(remoteAddress, -1, uri, method, status, time);
        	}
        }
    }
