...
public class TestWeightedRoundRobinStrategy {
	
	@Test
	public void testEvenDistribution() {
		doTestRR(new float[] { 1, 0.63f, 1.23f, 3.17f }, 0.001f, 0.001f);
		doTestRR(new float[] { 1, 1, 1, 2 }, 0.001f, 0.001f);
		doTestRR(new float[] { 1, 1, 1, 3 }, 0.001f, 0.001f);
		doTestRR(new float[] { 100, 200, 300, 400 }, 0.001f, 0.001f);
	}
	...
	public void doTestRR(float[] weights, float maxSameRatio, float maxDistributionError) {
		...
		LoadBalancingStrategy stragegy = new WeightedRoundRobinStragegy(weights);
